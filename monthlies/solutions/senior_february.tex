...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=0.9cm,y=0.9cm]
	\clip(-9.0,-6.5) rectangle (7.5,7.5);
...
Without loss of generality, let $Q$ lie between $D$ and $F$. If this isn't the case, by symmetry the following still would work.
