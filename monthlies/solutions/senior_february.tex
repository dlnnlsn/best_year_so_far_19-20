...
\definecolor{rvwvcq}{rgb}{0.08235294117647059,0.396078431372549,0.7529411764705882}
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1cm,y=1cm]
\clip(-9.283559987000446,-6.57625282241214) rectangle (19.381304302431502,7.540833931147832);
 (-1.31,5.11) -- (-5.455197477560457,-1.7617679365822296) -- (2.568526863211355,-1.9157302875616482) -- cycle;
\draw [line width=0.4pt,color=wrwrwr] (-1.31,5.11)-- (-5.455197477560457,-1.7617679365822296);
\draw [line width=0.4pt,color=wrwrwr] (-5.455197477560457,-1.7617679365822296)-- (2.568526863211355,-1.9157302875616482);
\draw [line width=0.4pt,color=wrwrwr] (2.568526863211355,-1.9157302875616482)-- (-1.31,5.11);
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(-30.183975107256657-6.87176793658223*\x)/-4.1451974775604565});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(-14.975835304248369-0.15396235097941857*\x)/8.023724340771812});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(-10.615565594304266--7.0257302875616485*\x)/-3.878526863211355});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(--1.148143552176006--3.435883968291115*\x)/2.0725987387802283});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(-6.45592634932814--0.0769811754897094*\x)/-4.011862170385906});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(-8.63606120430019-3.5128651437808243*\x)/1.9392634316056778});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(--14.58742692855705--3.5740494610379048*\x)/-5.127874754608706});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(-10.438926137493052--3.5740494610379048*\x)/-5.127874754608706});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(--3.504917863959271--3.5740494610379048*\x)/-5.127874754608706});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(--29.94074793065018--4.358649068622216*\x)/0.7486596288139937});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(-5.049541293151948-6.4111737943942355*\x)/5.297031407263448});
\draw [line width=0.4pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(--2.9964813654064137--2.052524725772019*\x)/-6.045691036077442});
\draw [line width=0.4pt,dash pattern=on 1pt off 1pt,color=wrwrwr,domain=-9.283559987000446:19.381304302431502] plot(\x,{(-22.357699881128205--4.499323905961608*\x)/10.051477896670233});
\begin{scriptsize}
\draw [fill=black] (-1.31,5.11) circle (0.5pt);
\draw[color=black] (-1.1801926753524612,5.331549732991836) node {$A$};
\draw [fill=black] (-5.455197477560457,-1.7617679365822296) circle (0.5pt);
\draw[color=black] (-5.327585393912453,-1.5435512735441501) node {$B$};
\draw [fill=black] (2.568526863211355,-1.9157302875616482) circle (0.5pt);
\draw[color=black] (2.696024365455531,-1.70306637810415) node {$C$};
\draw [fill=black] (-1.443335307174551,-1.8387491120719388) circle (0.5pt);
\draw[color=black] (-1.307804759000461,-1.62330882582415) node {$D$};
\draw [fill=black] (0.6292634316056775,1.597134856219176) circle (0.5pt);
\draw[color=black] (0.749940089823535,1.8062659222158433) node {$E$};
\draw [fill=black] (-3.3825987387802288,1.6741160317088855) circle (0.5pt);
\draw[color=black] (-3.2538890346324574,1.886023474495843) node {$F$};
\draw [fill=black] (-6.5712100617832565,1.735300348965966) circle (0.5pt);
\draw[color=black] (-6.444191125832451,1.9498295163198431) node {$P$};
\draw [fill=black] (-0.5255190257058148,-0.31722437680605303) circle (0.5pt);
\draw[color=black] (-0.3985686630084627,-0.10791533250415289) node {$R$};
\draw [fill=black] (-5.822550432969263,6.093949417588182) circle (0.5pt);
\draw[color=black] (-5.6944701344004525,6.304591870807834) node {$Q$};
\draw [fill=black] (-7.855296739267298,-5.740571175871619) circle (0.5pt);
\draw[color=black] (-7.720311962312448,-5.531428887544143) node {$X$};
\draw [fill=black] (0.7666294508162076,-1.8811547774800792) circle (0.5pt);
\draw[color=black] (0.8935036839275348,-1.6711633571921498) node {$Y$};
\draw [fill=black] (2.1961811574029353,-1.2412472699100106) circle (0.5pt);
\draw[color=black] (2.329139624967532,-1.033102938952151) node {$Z$};
\end{scriptsize}
\end{tikzpicture}

We first prove the following lemma:

Given an equilateral triangle $DEF$ with points $P$ on $EF$, $Q$ on $DF$, and $R$ on $DE$ such that $PD \parallel QE \parallel FR$, then

$$\frac{QD}{RD} \cdot \frac{RE}{PE} \cdot \frac{PF}{QF} = 1$$

WLOG, let $Q$ lie between $D$ and $F$. If this isn't the case, by symmetry the following still would work.

Since $PD \parallel QE \parallel FR$, we get $\angle PDE = \angle QDE = \angle FRD = \angle EFR = \alpha$.
...
\begin{align*}
\frac{BX}{CX} \cdot \frac{CY}{AY} \cdot \frac{AZ}{BZ} &= \frac{QX}{RX} \cdot \frac{RY}{PY} \cdot \frac{PZ}{QZ}\\
&= 1
\end{align*}
