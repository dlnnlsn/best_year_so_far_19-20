...
\medskip
\item %Adapted from Sharygin 2005, G11 P1
Let the midpoints of the sides $BC,CA,AB$ of an equilateral triangle $ABC$ be $D,E,F$ respectively. Let $j,k,\ell$ be lines passing through $D,E,F$ respectively such that $j||k||\ell$. Define points $P,Q,R$ by $P= j\cap EF, Q= k \cap FD, R = \ell \cap DE$. Prove that the points $X,Y,Z$ defined by $X= BC\cap QR, Y= CA \cap RP, Z = AB \cap PQ$ are  collinear.
