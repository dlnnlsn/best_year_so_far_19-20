...
$$\Rightarrow (a^5)^2 \equiv _{11} 1$$
$$\Rightarrow 11 \; | \; (a^5)^2 - 1$$
$$\Rightarrow 11 \; | \; (a^5 - 1)(a^5 + 1)$$
Since $11$ is prime, we must have $11 \; | \; a^5 - 1 \Rightarrow a^5 \equiv _{11} 1$ or $11 \; | \; a^5 + 1 \Rightarrow a^5 \equiv _{11} -1$. When $11 \; | \; a$, $a^5 \equiv _{11} 0$.
This shows that the only values of powers of $5$ mod $11$ are $-1$, $0$ and $1$. Notice that: 
$$2050^{2051} \equiv _{11} (2050^{205})^{10} \times 2050 \equiv _{11} 1 \times 2050 \equiv _{11} 4$$ 
and the smallest way to express $4$ as the sum of some values from $\{-1, 0, 1\}$ is $4 = 1 + 1 + 1 + 1$.
This shows that $2050^{2051}$ cannot be expressed as the sum of less than $4$ fifth powers, so $k = 4$ is a lower bound.
Notice that $2050^{2051} = 2050^{2050} \times 2050^{1} = (2050^{410})^{5} \times 2050^{1}$ and that $2050 = 1024 + 1024 + 1 + 1 = 4^5 + 4^5 + 1^5 + 1^5$. This shows that $k = 4$ is possible and minimal.
