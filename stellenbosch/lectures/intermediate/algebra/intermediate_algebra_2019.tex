...
\begin{theorem}[Cauchy-Schwartz Inequality]
    ...
    with equality when there exists some nonzero constant $k$ such that $ka_i = b_i$ for all $i$.
\end{theorem}
\begin{theorem}[Cauchy-Schwartz Inequality in Engel Form / Titu's Lemma]
    For positive reals $a_i$ and $b_i$
    $$\frac{a_1^2}{b_1} + \frac{a_2^2}{b_2} + \dots + \frac{a_n^2}{b_n} \ge \frac{a_1^2 + a_2^2 + a_3^2 + \dots + a_n^2}{b_1 + b_2 + b_3 + \dots + b_n}$$
\end{theorem}

Engel form is derived by substituting $a_i = \frac{x_i}{\sqrt{y_i}}$ and $b_i = \sqrt{y_i}$.


\begin{exercise}[PAMO 2015 Q1]
    Show that for all $x$ where the expression is well-defined:
